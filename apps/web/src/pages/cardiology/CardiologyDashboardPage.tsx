...
export default function CardiologyDashboardPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <PageHeader
        title={t('cardiology.dashboard') || 'Tableau de Bord Cardiologie'}
        subtitle={t('cardiology.dashboardSubtitle') || 'Vue d\'ensemble du département de cardiologie'}
        icon={Heart}
        module="cardiology"
      />
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
        <StatsCard
          label={t('cardiology.totalPatients') || 'Patients totaux'}
          value={stats?.totalPatients || 0}
          icon={Heart}
          module="cardiology"
        />
        <StatsCard
          label={t('cardiology.todayAppointments') || 'RDV aujourd\'hui'}
          value={stats?.todayAppointments || 0}
          icon={Heart}
          module="cardiology"
        />
        <StatsCard
          label={t('cardiology.pendingEcgs') || 'ECG en attente'}
          value={stats?.pendingEcgs || 0}
          icon={Heart}
          module="cardiology"
        />
        <StatsCard
          label={t('cardiology.activePacemakers') || 'Pacemakers actifs'}
          value={stats?.activePacemakers || 0}
          icon={Heart}
          module="cardiology"
        />
        <StatsCard
          label={t('cardiology.criticalAlerts') || 'Alertes critiques'}
          value={stats?.criticalAlerts || 0}
          icon={Heart}
          module="cardiology"
        />
        <StatsCard
          label={t('cardiology.recentEvents') || 'Événements récents'}
      ...
      {/* Quick Actions */}
      <SectionCard>
        <h3 className="font-semibold mb-4 text-gray-900 dark:text-white">{t('cardiology.quickAccess') || 'Accès Rapide'}</h3>
