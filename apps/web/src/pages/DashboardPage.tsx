    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="rounded-lg border bg-card p-6 shadow-sm">
          <div className="flex flex-col space-y-1.5">
            ...
            <p className="text-xs text-muted-foreground">
              {invoices?.filter(i => i.status === 'overdue').length || 0} overdue
            </p>
          </div>
        </div>
      ...
      {!invoices?.length && !companies?.length && !contacts?.length && (
        <div className="rounded-lg border bg-card p-12 shadow-sm text-center">
          <h2 className="text-xl font-semibold mb-2">Get Started with Perfex ERP</h2>
          <p className="text-muted-foreground mb-6">
            Start by adding your first company or creating an invoice
          </p>
