...
app.post('/bakery', async (c) => {
  try {
    ...
    const suppliersData = [
      { name: 'Grands Moulins de Paris', type: 'manufacturer', email: 'commandes@grandsmoulins.fr', phone: '+33 1 45 67 89 00' },
      { name: 'Lesaffre Levures', type: 'manufacturer', email: 'france@lesaffre.com', phone: '+33 3 20 81 61 00' },
      { name: 'Metro Cash & Carry', type: 'distributor', email: 'pro@metro.fr', phone: '+33 1 41 41 41 41' },
    ];
